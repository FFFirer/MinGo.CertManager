...
COPY src/MinGo.CertManager.SDK.Tests/MinGo.CertManager.SDK.Tests.csproj src/MinGo.CertManager.Tests.SDK/
COPY src/MinGo.CertManager.Tests/MinGo.CertManager.Tests.csproj src/MinGo.CertManager.Tests/
